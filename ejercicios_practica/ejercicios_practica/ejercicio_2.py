...
print("El resulado de restar", numero_1, "y", numero_2, "es", resta)

# División
multiplicacipon = numero_1 * numero_2
print("El resulado de multiplicar", numero_1, "y", numero_2, "es", multiplicacipon)

# Multiplicación
division = numero_1 / numero_2
print("El resulado de dividir", numero_1, "y", numero_2, "es", division)
